package com.geekbang.dynamicdatasource.database.aspect;

import com.geekbang.dynamicdatasource.database.datasource.ManagementCenter;
...
public class ReadAspect {
    ...
    @Pointcut("@annotation(com.geekbang.dynamicdatasource.database.annotation.ReadAnnotation)")
    public void read(){};
